...
<body>
    ...
    <main class="container">
        ...
        <ul class="remove-dot">
            ...
            <li>
                <a href="#OP"><img src="images/other.jpg" class="product-img"></a>Other Services
            </li>
            </li>
        </ul>
        ...
        <div id="JH" name="JH">
            ...
            <?php foreach ($services as $sevice) {
                if ($sevice['description'] != NULL) {
            ?>
                    <h3><?php echo $sevice['servicegiver'] ?></h3>
                    <p><?php echo $sevice['description'] ?></p>
                    <a target=_blank href="<?php echo htmlspecialchars($addr) ?>">
            ...
            <details>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <?php foreach ($services as $sevice) { ?>
                            <h3 style="color: #9844ff"><?php echo $sevice['servicegiver'] ?></h3>
