...
<body>
    ...
    <main class="container">
        ...
        <div id="TL" name="TL">
            ...
            <p>The daily menu is:</p>
            <details>
                <summary>Breakfast</summary>

                <table class="product-back-img1">
                    <tr>
                        <th>Food</th>
                        <th>Price</th>
                    </tr>
                    <tr>
                        <td>Yesinde Kinche</td>
                        <td>25</td>
                    </tr>
                    <tr>
                        <td>Dabo Firfr</td>
            ...
            <details>
                ...
                <summary>Lunch and Dinner</summary>

                <ul class="remove-dot">
                    <table width="80%" class="product-back-img1">
                        <td width="40%">
                            <p>Food</p>
                            <li>Ater kik</li>
                            <li>Dinich Bealcha</li>
                            <li>Shiro</li>
                            <li>Pasta</li>
                            <li>Tibs</li>
                            <li>Minchet</li>
        ...
        <div id="KNL" name="KNL">
            ...
            <details>
                <summary>Breakfast</summary>
                <ul class="remove-dot">
                    <table width="80%" class="product-back-img2">
                        <td width="40%">
                            <p>Food</p>
                            <li>Ful</li>
                            <li>Sandwich</li>
        ...
        <div id="KK" name="KK">
            ...
            <details>
                ...
                <ul class="remove-dot">
                    <table width="80%" class="product-back-img3">
                        <td width="40%">
                            <p>Food And Drinks</p>
                            <li>Pancake</li>
                            <li>Pasta</li>
        ...
        <div id="JH" name="JH">
            ...
            <details>
                <summary>The daily menu is:</summary>
                <ul class="remove-dot">
                    <table width="80%" class="product-back-img4">
                        <td width="40%">
                            <p>Food And Drinks</p>
                            <li>Pancake</li>
                            <li>Pasta</li>
